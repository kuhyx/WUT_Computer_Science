...
| `Programming/PBAD` | blocked | - | jupyter is on PATH but does not run (dead shim) |
...
| `Programming/twm_4` | blocked | - | jupyter is on PATH but does not run (dead shim) |
