...
<s> It does not include projects I did in groups like: <br/>
...
Thanks to some git magic this repo now CONTAINS all the group projects alongside with all proper contributors
