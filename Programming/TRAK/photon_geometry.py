#!/usr/bin/env python3
"""Vectors, photons and the two surfaces the photon mapper traces.

Split out of `photon_mapping.py` so each file stays under this repo's
250-line cap; the classes are unchanged.
"""
